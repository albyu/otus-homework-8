...
public class TransportableOrder {
    ...
    private Set<ru.boldyrev.otus.model.transfer.TransportableOrderItem> orderItems;
    ...
    public TransportableOrder(Order order) {
        ...
        for (OrderItem item : order.getOrderItems()) {
            ru.boldyrev.otus.model.transfer.TransportableOrderItem transportableOrderItem = new TransportableOrderItem(item);
